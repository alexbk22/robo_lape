...
if("TRUE" STREQUAL "TRUE")
  set(rplidar_ros_SOURCE_PREFIX /home/pi/git/robo_lape/src/rplidar_ros)
  set(rplidar_ros_DEVEL_PREFIX /home/pi/git/robo_lape/devel)
  ...
  set(rplidar_ros_INSTALL_PREFIX /home/pi/git/robo_lape/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rplidar_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/git/robo_lape/src/rplidar_ros/${idir}'.  ${_report}")
    endif()
