...
if("TRUE" STREQUAL "TRUE")
  set(eigen_conversions_SOURCE_PREFIX /home/pi/git/robo_lape/src/geometry/eigen_conversions)
  set(eigen_conversions_DEVEL_PREFIX /home/pi/git/robo_lape/devel)
  ...
  set(eigen_conversions_INSTALL_PREFIX /home/pi/git/robo_lape/install)
...
if(NOT "/home/pi/git/robo_lape/src/geometry/eigen_conversions/include;/usr/include/eigen3 " STREQUAL " ")
  set(eigen_conversions_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/git/robo_lape/src/geometry/eigen_conversions/include;/usr/include/eigen3")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'eigen_conversions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/git/robo_lape/src/geometry/eigen_conversions/${idir}'.  ${_report}")
    endif()
