...
if("TRUE" STREQUAL "TRUE")
  set(tf_SOURCE_PREFIX /home/pi/git/robo_lape/src/geometry/tf)
  set(tf_DEVEL_PREFIX /home/pi/git/robo_lape/devel)
  set(tf_INSTALL_PREFIX "")
  set(tf_PREFIX ${tf_DEVEL_PREFIX})
else()
  set(tf_SOURCE_PREFIX "")
  set(tf_DEVEL_PREFIX "")
  set(tf_INSTALL_PREFIX /home/pi/git/robo_lape/install)
...
if(NOT "/home/pi/git/robo_lape/devel/include;/home/pi/git/robo_lape/src/geometry/tf/include " STREQUAL " ")
  set(tf_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/git/robo_lape/devel/include;/home/pi/git/robo_lape/src/geometry/tf/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/git/robo_lape/src/geometry/tf/${idir}'.  ${_report}")
    endif()
