...
if("TRUE" STREQUAL "TRUE")
  set(tf2_tools_SOURCE_PREFIX /home/pi/git/robo_lape/src/geometry2/tf2_tools)
  set(tf2_tools_DEVEL_PREFIX /home/pi/git/robo_lape/devel)
  ...
  set(tf2_tools_INSTALL_PREFIX /home/pi/git/robo_lape/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tf2_tools' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/git/robo_lape/src/geometry2/tf2_tools/${idir}'.  ${_report}")
    endif()
